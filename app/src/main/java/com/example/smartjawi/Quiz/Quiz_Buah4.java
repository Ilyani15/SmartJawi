...
public class Quiz_Buah4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnOp1 = findViewById(R.id.sawi);
        btnOp2 = findViewById(R.id.kubis);
        btnOp3 = findViewById(R.id.tembikai);
        ...
        btnOp1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        MediaPlayer media = MediaPlayer.create(Quiz_Buah4.this, R.raw.wrong);
                        media.start();
                        Intent intent = new Intent(Quiz_Buah4.this, Quiz_Buah5.class);
        ...
        btnOp4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        MediaPlayer media = MediaPlayer.create(Quiz_Buah4.this, R.raw.correct);
                        media.start();
                        Intent intent = new Intent(Quiz_Buah4.this, Quiz_Buah5.class);
                        intent.putExtra("RA", great);
                        startActivity(intent);
        ...
        close.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Quiz_Buah4.this, QuizFragment.class);
                startActivity(intent);
                finish();
            }
        });
