    ...
    private void saveQuizResult(int result) {
        if (firebaseUser != null) {
            ...
            collectionReference.document("attempt_data").get()
                        ...
                        if (documentSnapshot.exists()) {
                            ...
                            collectionReference.document("attempt_data").set(data)
                                    .addOnSuccessListener(aVoid -> {
                                        ...
                                        Toast.makeText(Quiz_ResultHaiwan.this, "Quiz result and attempt count saved successfully", Toast.LENGTH_SHORT).show();
                                    })
                                    .addOnFailureListener(e -> {
                                        Toast.makeText(Quiz_ResultHaiwan.this, "Failed to save attempt count", Toast.LENGTH_SHORT).show();
                                    });
                        } else {
                    ...
                    .addOnFailureListener(e -> {
                        Toast.makeText(Quiz_ResultHaiwan.this, "Failed to retrieve attempt count", Toast.LENGTH_SHORT).show();
                    });
