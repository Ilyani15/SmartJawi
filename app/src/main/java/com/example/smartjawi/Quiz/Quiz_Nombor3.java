...
public class Quiz_Nombor3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nombor3);
        ...
        btnOp1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        MediaPlayer media = MediaPlayer.create(Quiz_Nombor3.this, R.raw.wrong);
                        media.start();
                        Intent intent = new Intent(Quiz_Nombor3.this, Quiz_Nombor4.class);
        ...
        btnOp3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        MediaPlayer media = MediaPlayer.create(Quiz_Nombor3.this, R.raw.correct);
                        media.start();
                        Intent intent = new Intent(Quiz_Nombor3.this, Quiz_Nombor4.class);
                        intent.putExtra("RA", great3);
                        startActivity(intent);
        ...
        close.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Quiz_Nombor3.this, QuizFragment.class);
                startActivity(intent);
                finish();
            }
        });
