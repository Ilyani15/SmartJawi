...
public class Quiz_Haiwan5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_haiwan5);


        questionImage = findViewById(R.id.questionImage);

        btnOp1 = findViewById(R.id.tikus);
        ...
        btnOp1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        MediaPlayer media = MediaPlayer.create(Quiz_Haiwan5.this, R.raw.correct);
                        media.start();
                        Intent intent = new Intent(Quiz_Haiwan5.this, Quiz_ResultHaiwan.class);
        ...
        btnOp2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        MediaPlayer media = MediaPlayer.create(Quiz_Haiwan5.this, R.raw.wrong);
                        media.start();
                        Intent intent = new Intent(Quiz_Haiwan5.this, Quiz_ResultHaiwan.class);
                        intent.putExtra("RA", great1);
                        startActivity(intent);
        ...
        close.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Quiz_Haiwan5.this, QuizFragment.class);
                startActivity(intent);
                finish();
            }
        });
