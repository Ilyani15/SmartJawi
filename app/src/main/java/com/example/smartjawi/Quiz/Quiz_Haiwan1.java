...
public class Quiz_Haiwan1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_haiwan1);
        ...
        btnOp1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        MediaPlayer media = MediaPlayer.create(Quiz_Haiwan1.this, R.raw.wrong);
                        media.start();
                        Intent intent = new Intent(Quiz_Haiwan1.this, Quiz_Haiwan2.class);
        ...
        btnOp3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        MediaPlayer media = MediaPlayer.create(Quiz_Haiwan1.this, R.raw.correct);
                        media.start();
                        Intent intent = new Intent(Quiz_Haiwan1.this, Quiz_Haiwan2.class);
                        intent.putExtra("RA", great1);
                        startActivity(intent);
        ...
        close.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Quiz_Haiwan1.this, QuizFragment.class);
                startActivity(intent);
                finish();
            }
        });
