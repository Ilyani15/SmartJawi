...
public class Quiz_Nombor4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nombor4);
        ...
        btnOp1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        MediaPlayer media = MediaPlayer.create(Quiz_Nombor4.this, R.raw.wrong);
                        media.start();
                        Intent intent = new Intent(Quiz_Nombor4.this, Quiz_Nombor5.class);
        ...
        btnOp3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        MediaPlayer media = MediaPlayer.create(Quiz_Nombor4.this, R.raw.correct);
                        media.start();
                        Intent intent = new Intent(Quiz_Nombor4.this, Quiz_Nombor5.class);
                        intent.putExtra("RA", great3);
                        startActivity(intent);
        ...
        close.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Quiz_Nombor4.this, QuizFragment.class);
                startActivity(intent);
                finish();
            }
        });
