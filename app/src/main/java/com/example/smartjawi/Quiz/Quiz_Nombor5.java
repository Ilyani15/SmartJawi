...
public class Quiz_Nombor5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nombor5);

        questionImage = findViewById(R.id.questionImage);

        btnOp1 = findViewById(R.id.tiga);
        btnOp2 = findViewById(R.id.satu);
        btnOp3 = findViewById(R.id.sembilan);
        ...
        btnOp1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        MediaPlayer media = MediaPlayer.create(Quiz_Nombor5.this, R.raw.correct);
                        media.start();
                        Intent intent = new Intent(Quiz_Nombor5.this, Quiz_ResultNombor.class);
        ...
        btnOp2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        MediaPlayer media = MediaPlayer.create(Quiz_Nombor5.this, R.raw.wrong);
                        media.start();
                        Intent intent = new Intent(Quiz_Nombor5.this, Quiz_ResultNombor.class);
                        intent.putExtra("RA", great3);
                        startActivity(intent);
        ...
        close.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Quiz_Nombor5.this, QuizFragment.class);
                startActivity(intent);
                finish();
            }
        });
