...
public class Quiz_Haiwan2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_haiwan2);
        ...
        btnOp3 = findViewById(R.id.lembu);
        ...
        btnOp1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        MediaPlayer media = MediaPlayer.create(Quiz_Haiwan2.this, R.raw.wrong);
                        media.start();
                        Intent intent = new Intent(Quiz_Haiwan2.this, Quiz_Haiwan3.class);
        ...
        btnOp4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        MediaPlayer media = MediaPlayer.create(Quiz_Haiwan2.this, R.raw.correct);
                        media.start();
                        Intent intent = new Intent(Quiz_Haiwan2.this, Quiz_Haiwan3.class);
                        intent.putExtra("RA", great1);
                        startActivity(intent);
        ...
        close.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Quiz_Haiwan2.this, QuizFragment.class);
                startActivity(intent);
                finish();
            }
        });
