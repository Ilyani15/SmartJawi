...
public class DD_Game_Warna1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dd_warna1);
        ...
        correct = MediaPlayer.create(DD_Game_Warna1.this, R.raw.correct);
        ...
        close.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(DD_Game_Warna1.this, GameFragment.class);
    ...
    private void handleDragDrop(View view, int targetId) {
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                Intent intent = new Intent(DD_Game_Warna1.this, DD_Game_Warna2.class);
                startActivity(intent);
                finish();
            }
        }, 1000);
    ...
    private void handleDragDropIncorrect() {
        MediaPlayer media = MediaPlayer.create(DD_Game_Warna1.this, R.raw.wrong);
        media.start();
    }
}