...
public class DD_Game_Buah2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dd_buah2);
        ...
        correct = MediaPlayer.create(DD_Game_Buah2.this, R.raw.correct);
        ...
        close.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(DD_Game_Buah2.this, GameFragment.class);
    ...
    private void handleDragDrop(View view, int targetId) {
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                Intent intent = new Intent(DD_Game_Buah2.this, DD_Game_Buah3.class);
                startActivity(intent);
                finish();
            }
        }, 1000);
    ...
    private void handleDragDropIncorrect() {
        MediaPlayer media = MediaPlayer.create(DD_Game_Buah2.this, R.raw.wrong);
        media.start();
    }
}