...
public class Cw_nombor extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.activity_cw_nombor);

            final MediaPlayer note1 = MediaPlayer.create(com.example.smartjawi.Game.Cw.Cw_nombor.this, R.raw.note1);
            final MediaPlayer note2 = MediaPlayer.create(com.example.smartjawi.Game.Cw.Cw_nombor.this, R.raw.note2);
            final MediaPlayer note3 = MediaPlayer.create(com.example.smartjawi.Game.Cw.Cw_nombor.this, R.raw.note3);
            final MediaPlayer note4 = MediaPlayer.create(com.example.smartjawi.Game.Cw.Cw_nombor.this, R.raw.note4);
            final MediaPlayer note5 = MediaPlayer.create(com.example.smartjawi.Game.Cw.Cw_nombor.this, R.raw.note5);
            final MediaPlayer note6 = MediaPlayer.create(com.example.smartjawi.Game.Cw.Cw_nombor.this, R.raw.note6);
            final MediaPlayer note7 = MediaPlayer.create(com.example.smartjawi.Game.Cw.Cw_nombor.this, R.raw.note7);
            final MediaPlayer note8 = MediaPlayer.create(com.example.smartjawi.Game.Cw.Cw_nombor.this, R.raw.note8);
            final MediaPlayer note9 = MediaPlayer.create(com.example.smartjawi.Game.Cw.Cw_nombor.this, R.raw.note9);
            final MediaPlayer bingo1 = MediaPlayer.create(com.example.smartjawi.Game.Cw.Cw_nombor.this, R.raw.bingo1);
...
//getscore
            ...
            choice1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (textinputsecondary.equals("سمبيلن") && !lockscore1.equals("1")) {
                        textView12.setText("س");
                        textView13.setText("م");
                        textView14.setText("ب");
                        textView15.setText("ي");
                        textView16.setText("ل");
                        textView17.setText("ن");
                        editor.putString("textinput", "");
                        editor.apply();
                        input.setText("");
                    ...
                    else if (textinputsecondary.equals("سمبيلن")) {
                        editor.putString("textinput", "");
                        editor.apply();
                        input.setText("");
                        editor.putString("soundinput", "1");
                    ...
                    if (textinputsecondary.equals("ساتو") && !lockscore2.equals("1")) {
                        textView12.setText("س");
                        textView19.setText("ا");
                        textView20.setText("ت");
                        textView21.setText("و");
                        editor.putString("textinput", "");
                        editor.apply();
                        input.setText("");
                    ...
                    else if (textinputsecondary.equals("ساتو")) {
                        editor.putString("textinput", "");
                        editor.apply();
                        input.setText("");
                        editor.putString("soundinput", "1");
                    ...
                    if (textinputsecondary.equals("ليم") && !lockscore3.equals("1")) {
                        textView16.setText("ل");
                        textView22.setText("ي");
                    ...
                    else if (textinputsecondary.equals("ليم")) {
                        editor.putString("textinput", "");
                        editor.apply();
                        input.setText("");
                        editor.putString("soundinput", "1");
                    ...
                    if (textinputsecondary.equals("تيݢ") && !lockscore4.equals("1")) {
                        textView20.setText("ت");
                        textView25.setText("ي");
                        textView26.setText("ݢ");
                        editor.putString("textinput", "");
                        editor.apply();
                        input.setText("");
                    ...
                    else if (textinputsecondary.equals("تيݢ")) {
                        editor.putString("textinput", "");
                        editor.apply();
                        input.setText("");
                        editor.putString("soundinput", "1");
...
//E:choice button on click
                    ...
                    if (soundinput2 == 1 && !textinputsecondary.equals("سمبيلن") && !textinputsecondary.equals("ساتو") && !textinputsecondary.equals("ليم") && !textinputsecondary.equals("تيݢ") ) {
                        //play music
                        note1.start();
                    }
                    ...
                    if (soundinput2 == 2 && !textinputsecondary.equals("سمبيلن") && !textinputsecondary.equals("ساتو") && !textinputsecondary.equals("ليم") && !textinputsecondary.equals("تيݢ") ) {
                        //play music
                        note2.start();
                    }
                    ...
                    if (soundinput2 == 3 && !textinputsecondary.equals("سمبيلن") && !textinputsecondary.equals("ساتو") && !textinputsecondary.equals("ليم") && !textinputsecondary.equals("تيݢ") ) {
                        //play music
                        note3.start();
                    }
                    ...
                    if (soundinput2 == 4 && !textinputsecondary.equals("سمبيلن") && !textinputsecondary.equals("ساتو") && !textinputsecondary.equals("ليم") && !textinputsecondary.equals("تيݢ") ) {
                        //play music
                        note4.start();
                    }
                    ...
                    if (soundinput2 == 6 && !textinputsecondary.equals("سمبيلن") && !textinputsecondary.equals("ساتو") && !textinputsecondary.equals("ليم") && !textinputsecondary.equals("تيݢ") ) {
                        //play music
                        note6.start();
                    }
                    ...
                    if (soundinput2 == 7 && !textinputsecondary.equals("سمبيلن") && !textinputsecondary.equals("ساتو") && !textinputsecondary.equals("ليم") && !textinputsecondary.equals("تيݢ") ) {
                        //play music
                        note7.start();
                    }
                    ...
                    if (soundinput2 == 5 && !textinputsecondary.equals("سمبيلن") && !textinputsecondary.equals("ساتو") && !textinputsecondary.equals("ليم") && !textinputsecondary.equals("تيݢ") ) {
                        //play music
                        note5.start();
                        editor.putString("textinput", "");
                        editor.apply();
...
//E:choice button on click
            ...
            choice5.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    //choice button on click
                    textinputsecondary = textinput + "ن";
                    editor.putString("textinput", textinputsecondary);
                    editor.apply();
                    input.setText(textinputsecondary);
                    if (textinputsecondary.equals("سمبيلن") && !lockscore1.equals("1")) {
...
//E:choice button on click
            ...
            close.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(com.example.smartjawi.Game.Cw.Cw_nombor.this, GameFragment.class);
