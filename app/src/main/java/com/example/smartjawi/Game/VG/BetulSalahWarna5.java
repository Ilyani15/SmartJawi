...
import com.example.smartjawi.Quiz.Quiz_ResultWarna;
import com.example.smartjawi.R;

public class BetulSalahWarna5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_betul_salah_warna5);
        ...
        btnOp1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Intent intent = new Intent(BetulSalahWarna5.this, Quiz_ResultWarna.class);
        ...
        close.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(BetulSalahWarna5.this, FirstVG.class);
                startActivity(intent);
                finish();
            }
        });
