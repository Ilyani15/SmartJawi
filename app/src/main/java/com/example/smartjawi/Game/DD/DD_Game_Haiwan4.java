...
public class DD_Game_Haiwan4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dd_haiwan4);
        ...
        correct = MediaPlayer.create(DD_Game_Haiwan4.this, R.raw.correct);
        ...
        close.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(DD_Game_Haiwan4.this, GameFragment.class);
